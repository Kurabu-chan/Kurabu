...
export class CancelUserRegisterCommandHandler
    implements ICommandHandler<CancelUserRegisterCommand, CancelUserRegisterCommandResult>
{
    constructor(
    ...
    async handle({ state }: CancelUserRegisterCommand): Promise<CancelUserRegisterCommandResult> {
