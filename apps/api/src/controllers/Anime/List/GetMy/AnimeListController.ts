...
import { GetMyUserAnimeListWebRequestHandler } from "#webreq/Anime/List/GetMy/GetMyUserAnimeListWebRequestHandler";
...
export class AnimeListController {
    ...
    private async get(req: Request, res: Response, arg: Options.Params) {
        ...
        const allowedStati = ["watching", "completed", "on_hold", "dropped", "plan_to_watch"];
