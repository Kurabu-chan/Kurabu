...
import { GetMyUserAnimeListWebRequestResult } from "./GetMyUserAnimeListWebRequestResult";
...
export class GetMyUserAnimeListWebRequestHandler
    implements IWebRequestHandler<GetMyUserAnimeListWebRequest, GetMyUserAnimeListWebRequestResult>
{
    async handle(query: GetMyUserAnimeListWebRequest): Promise<GetMyUserAnimeListWebRequestResult> {
