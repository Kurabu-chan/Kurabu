...
export class SeasonalWebRequestHandler
    implements IWebRequestHandler<AnimeSeasonalWebRequest, AnimeSeasonalWebRequestResult>
{
    async handle(query: AnimeSeasonalWebRequest): Promise<AnimeSeasonalWebRequestResult> {
        ...
        return {
            seasonal: json as ListPagination<MediaNode> & {
                season: Season;
            },
