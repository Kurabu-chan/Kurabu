...
import { ErrorResponse, fieldsToString, ListPagination, MediaNode } from "#helpers/BasicTypes";
import { baseRequest } from "#builders/requests/RequestBuilder";

@autoInjectable()
export class SuggestionsWebRequestHandler
    implements IWebRequestHandler<AnimeSuggestionsWebRequest, AnimeSuggestionsWebRequestResult>
{
    async handle(query: AnimeSuggestionsWebRequest): Promise<AnimeSuggestionsWebRequestResult> {
