...
export class MangaRankingWebRequestHandler
    implements IWebRequestHandler<MangaRankingWebRequest, MangaRankingWebRequestResult>
{
    async handle(query: MangaRankingWebRequest): Promise<MangaRankingWebRequestResult> {
