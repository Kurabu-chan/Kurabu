...
import { mock, instance, when, anyNumber, anything, capture } from "ts-mockito";
import { param, ParamPos, ParamType } from "../../src/decorators/ParamDecorator";

let callbackListener: (success: any) => void = () => {};

class ParamMockClass {
    @param("cool", ParamType.int, false, ParamPos.either, (req, res, result, success) => {
    ...
    @param("cool", ParamType.boolean, false, ParamPos.either, (req, res, result, success) => {
        callbackListener(success);
    })
    ...
    @param("cool", ParamType.boolean, true, ParamPos.either, (req, res, result, success) => {
        callbackListener(success);
    })
    ...
    @param("cool", ParamType.number, false, ParamPos.either, (req, res, result, success) => {
        callbackListener(success);
    })
    ...
    @param("cool", ParamType.int, true, ParamPos.either, (req, res, result, success) => {
        callbackListener(success);
    })
    ...
    @param("cool", ParamType.number, true, ParamPos.either, (req, res, result, success) => {
        callbackListener(success);
    })
    ...
    @param("cool", ParamType.object, true, ParamPos.either, (req, res, result, success) => {
        callbackListener(success);
    })
    ...
    @param("cool", ParamType.string, true, ParamPos.either, (req, res, result, success) => {
        callbackListener(success);
    })
    ...
    @param("cool", ParamType.int, true, ParamPos.body, (req, res, result, success) => {
        callbackListener(success);
    })
    ...
    describe("ParamDecorator", () => {
        ...
        describe("Valid", () => {
            ...
            it("ParamDecorator should do object correctly", async () => {
                ...
                expect(JSON.stringify(argResultQuery.cool)).to.equal(JSON.stringify(expected));
