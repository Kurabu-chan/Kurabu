...
import {
	GetMyUserMangaListWebRequestHandler
} from "#webreq/Manga/List/GetMy/GetMyUserMangaListWebRequestHandler";
...
export class MangaListController {
	...
	private async get(req: Request, res: Response, arg: Options.Params) {
		...
		const status = arg.status as
			"reading" | "completed" | "on_hold" | "dropped" | "plan_to_read" | undefined;
