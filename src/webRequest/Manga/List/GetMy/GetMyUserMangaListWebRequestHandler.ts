...
import {
	GetMyUserMangaListWebRequestResult,
} from "./GetMyUserMangaListWebRequestResult";
...
export class GetMyUserMangaListWebRequestHandler
	implements
		IWebRequestHandler<
			GetMyUserMangaListWebRequest,
			GetMyUserMangaListWebRequestResult
		> {
	async handle(
		query: GetMyUserMangaListWebRequest
	): Promise<GetMyUserMangaListWebRequestResult> {
